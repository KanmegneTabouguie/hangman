...
func updateScore(winner string, elapsedTime time.Duration) {
	// Calculate score based on time taken
	// Adjust the scoring logic based on your preferences
	score := int(100 / elapsedTime.Seconds())

	// Increase the score of the winner by the calculated score
	playerScores[winner] += score
}
